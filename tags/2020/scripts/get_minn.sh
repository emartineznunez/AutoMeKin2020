...
###sqlite3
     ...
     sqlite3 $dir/TSs/SORTED/tss${ext}.db "select freq from tss${ext} where name='$lts'" | awk '{if($1>0) printf "%10.0f\n",$1}'  >> tmp_min/RRKM/proc1_TS${procn}.dat
###
...
###sqlite3
     ...
     sqlite3 $dir/TSs/SORTED/tss${ext}.db "select freq from tss${ext} where name='$lts'" | awk '{if($1>0) printf "%10.0f\n",$1}'  >> tmp_min/RRKM/proc2_TS${procn}.dat
###
