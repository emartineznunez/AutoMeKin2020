...
do
   ...
   sqlite3 ${minpath}/mins.db "select natom,geom from mins where lname='$file'" | sed 's@|@\n\n@g' >mingeom
...
do 
  ...
  sqlite3 ${tsdirll}/MINs/min.db "select natom,geom from min where name='$name2'" | sed 's@|@\n\n@g' >minfailed_structure
